...
public class HireFragment extends Fragment {
    ...
    private List<HiringRequest> mUser;
    ImageView iv;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.hire_recyclerView);
        recyclerView.setHasFixedSize(true);

        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        mUser=new ArrayList<>();
        HireAdapter=new HireAdapter(getContext(),mUser,true);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        HiringRequest user = snapshot.getValue(HiringRequest.class);
